...
const COURSE_DATA = {
  title:
    "Bimbingan Teknis Hukum Acara Pengujian Hasil Pemilihan Umum Angkatan 2",
  category: "Bimtek PHPU",
  modules: 11,
  hours: 30,
  participants: 229,
  lastUpdate: "12/2024",
  ...
  prerequisites:
    "Tidak ada persyaratan khusus untuk kursus ini, meskipun akan sangat membantu jika Anda terbiasa mengoperasikan internet.",
  overview:
  ...
  learningGoals: [
    ...
    "Hukum Pidana",
    "Hukum Perdata",
    "Analisa Tahapan dan Penanganan",
    "Studi banding hasil pemilu antar periode",
    "Putusan",
  ],
  contentFeatures: [
    ...
    {
      label: "Akses di berbagai perangkat",
      value: "Mac, PC, Ipad atau Mobile",
    },
  ...
  curriculum: [
    {
      title: "Dinamika Penanganan Perkara",
      subCount: 3,
      duration: 9,
      items: [
        ...
        {
          name: "HTML5 Foundations Certification Final Project",
          time: "02:40",
          preview: false,
        },
      ],
    ...
    {
      title: "Perselisihan Hasil Pemilihan Gubernur",
      subCount: 3,
      duration: 9,
      items: [
        { name: "About The Course", time: "01:20", preview: true },
        { name: "Tools Introduction", time: "07:50", preview: true },
        {
          name: "HTML5 Basic Document Structure",
          time: "06:30",
          preview: true,
        },
        {
    ...
    {
      title: "Perselisihan Hasil Pemilihan Wakil Gubernur",
      subCount: 3,
      duration: 9,
      items: [
        { name: "About The Course", time: "01:20", preview: true },
    ...
    {
      title: "Perselisihan Hasil Pemilihan Walikota dan Wakil Walikota",
      subCount: 3,
      duration: 9,
      items: [
        { name: "About The Course", time: "01:20", preview: true },
...
function CurriculumSection({
  ...
  duration,
  items,
}: (typeof COURSE_DATA.curriculum)[0]) {
  ...
  return (
    <View style={styles.curriculumSection}>
      <TouchableOpacity
        ...
        onPress={() => !isPlaceholder && setIsExpanded(!isExpanded)}
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
          ...
          <View style={{ flex: 1, marginLeft: isPlaceholder ? 10 : 0 }}>
            <Text
              style={[
                styles.curriculumTitle,
                isPlaceholder && { color: "#666" },
              ]}
            >
              {title}
            </Text>
            {subCount > 0 && (
              <Text style={styles.curriculumSubtitle}>
                {subCount} sub materi | {duration} min
              </Text>
            )}
          </View>
        </View>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() => router.push("/screens/modul/BimtekPHPU")}
      ...
      <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={styles.statText}>
                {COURSE_DATA.participants} Orang
              </Text>
            </View>
            <View style={styles.statItem}>
              <Ionicons name="time-outline" size={20} color={PRIMARY_COLOR} />
              <Text style={styles.statText}>
                Updated {COURSE_DATA.lastUpdate}
              </Text>
            </View>
          </View>
          <Text style={styles.organizerText}>
            Diselenggarakan Oleh: **{COURSE_DATA.organizer}**
          </Text>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            You can take this course using a Mac, PC or Mobile Phone.
          </Text>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          >
            <Text style={styles.showMoreText}>
              {showFullOverview ? "Tutup" : "Show More"}{" "}
              <Ionicons
