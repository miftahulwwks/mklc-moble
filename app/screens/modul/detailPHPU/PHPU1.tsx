...
const COURSE_DATA = {
  title:
    "Bimbingan Teknis Hukum Acara Pengujian Hasil Pemilihan Umum Angkatan 1",
...
function CurriculumSection({
  ...
  return (
    <View style={styles.curriculumSection}>
      ...
      {items.length === 0 && title.includes("Lainnya") && (
        <View style={styles.curriculumHeader}>
          <Text
            style={[styles.curriculumTitle, { color: "#666", marginLeft: 28 }]}
          >
            {title}
          </Text>
        </View>
