...
const BIMTEK_PHPU_DATA = [
  {
    ...
    modules: 7,
    hours: 16,
    detailPath: "/screens/modul/detailPHPU/PHPU1",
  },
  {
    id: 2,
    title:
    ...
    modules: 7,
    hours: 16,
    detailPath: "/screens/modul/detailPHPU/PHPU2",
  },
  {
    id: 3,
    title:
    ...
    modules: 7,
    hours: 16,
    detailPath: "/screens/modul/detailPHPU/PHPU3",
  },
];
...
const CourseCard = ({ course }: { course: Course }) => {
  ...
  const handleDetailPress = () => {
    const detailRoutes: { [key: number]: string } = {
      1: "screens/modul/detailPHPU/PHPU1",
      2: "screens/modul/detailPHPU/PHPU2",
      3: "screens/modul/detailPHPU/PHPU3",
    };
...
export default function BimtekPHPU() {
  const router = useRouter();
  const [selectedSort, setSelectedSort] = useState("Default");
  const [courses, setCourses] = useState<Course[]>(BIMTEK_PHPU_DATA);
  const [showSortOptions, setShowSortOptions] = useState(false);

  useEffect(() => {
    if (selectedSort === "Default") {
      setCourses([...BIMTEK_PHPU_DATA]);
      return;
    }

    const sorted = [...BIMTEK_PHPU_DATA].sort((a, b) => {
      ...
      <ScrollView style={{ flex: 1 }}>
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>Bimbingan Teknis PHPU</Text>
          </View>
        </View>

        <View style={styles.infoContainer}>
          <Text style={styles.pageSubtitle}>
            Pengujian Hasil Pemilihan Umum
          </Text>
          <Text style={styles.pageDescription}>
            Bimbingan teknis pengujian hasil pemilihan umum adalah proses
            pembelajaran dan pemberdayaan masyarakat tentang hak konstitusional
            warga negara dalam mengawasi dan melaporkan hasil pemilihan umum
            yang jujur dan adil.
          </Text>
        </View>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.filterRow}>
            <Text style={styles.resultCount}>
              Menampilkan 1 - {courses.length} dari {BIMTEK_PHPU_DATA.length}{" "}
              pendidikan
            </Text>
