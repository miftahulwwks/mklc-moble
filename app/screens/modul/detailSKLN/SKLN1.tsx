...
// --- DATA DUMMY SKLN ANGKATAN 1 ---
const COURSE_DATA = {
    // Judul disesuaikan untuk SKLN Angkatan 1
    title: "Bimbingan Teknis Hukum Acara Sengketa Kewenangan Lembaga Negara (SKLN) Angkatan 1", 
