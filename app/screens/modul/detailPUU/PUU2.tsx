...
// --- KONSTANTA WARNA BRANDING MK (Identik dengan PUU1.tsx) ---
...
// --- DATA DUMMY PUU ANGKATAN 2 (Data disalin dari PUU1 karena konten identik) ---
const COURSE_DATA = {
    // Perubahan minor pada title untuk membedakan dari PUU1
    title: "Pengujian Undang-Undang (PUU) Angkatan 2", 
    category: "Bimtek PUU",
    modules: 11,
    hours: 30, 
    participants: 229,
    ...
    curriculum: [
        ...
        { title: "Perselisihan Hasil Pemilihan Gubernur", subCount: 3, duration: 9, items: [
            { name: "About The Course", time: "01:20", preview: true },
            { name: "Tools Introduction", time: "07:50", preview: true },
            { name: "HTML5 Basic Document Structure", time: "06:30", preview: true },
            { name: "HTML5 Foundations Certification Final Project", time: "02:40", preview: false },
        ]},
...
function CurriculumSection({ title, subCount, duration, items }: typeof COURSE_DATA.curriculum[0]) {
    ...
    return (
        <View style={styles.curriculumSection}>
            ...
            {/* Hanya tampilkan label untuk "7 Materi Lainnya" tanpa konten yang bisa diexpand */}
            {items.length === 0 && title.includes('Lainnya') && (
                 <View style={styles.curriculumHeader}>
                    <Text style={[styles.curriculumTitle, {color: '#666', marginLeft: 28}]}>{title}</Text>
                 </View>
            )}
        </View>
    );
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle} numberOfLines={1}>{COURSE_DATA.title}</Text>
            </View>
...
// --- STYLESHEET (Disalin dari PUU1.tsx) ---
