...
// --- DATA DUMMY PUU ANGKATAN 3 ---
const COURSE_DATA = {
    // Judul disesuaikan untuk Angkatan 3
    title: "Bimbingan Teknis Hukum Acara Pengujian Undang-Undang (PUU) Angkatan 3", 
    category: "Bimtek PUU",
    modules: 11,
    hours: 30, 
    participants: 229,
...
// --- STYLESHEET (Disalin dari seri PUU/PHPU sebelumnya) ---
